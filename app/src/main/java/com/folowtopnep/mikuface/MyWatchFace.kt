package com.folowtopnep.mikuface
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        private fun initializeBackground() {
            ...
            val gradient: RadialGradient = RadialGradient(
                200.toFloat(), 200.toFloat(), 200.toFloat(), -0x1,
            ...
            mBackgroundBitmap = Bitmap.createBitmap(400, 400, Bitmap.Config.ARGB_8888)
            val c = Canvas(mBackgroundBitmap)
            c.drawCircle(200f, 200f, 200f, p)
